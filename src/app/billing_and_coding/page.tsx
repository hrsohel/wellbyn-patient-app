            ...
            <div className='flex items-center justify-between flex-wrap gap-4'>
                {
                    firstCardInfo.map(info =>
                        <div key={info.id} className='relative p-4 rounded-sm bg-white md:w-[20rem] w-full'>
            ...
            <div className='bg-white p-2 md:p-4'>
                <div className='flex items-center justify-between flex-wrap md:flex-nowrap'>
                    ...
                    <div className='flex items-center justify-center gap-4 flex-wrap mt-8 md:mt-0'>
                        ...
                        <div>
                            <select name="type" id="type" style={{boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)"}} className='w-full flex items-center justify-center gap-2 rounded-md p-2 border-none outline-none text-lg'>
                        ...
                        <div>
                            <select name="time" id="time" style={{boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)"}} className='w-full flex items-center justify-center gap-2 rounded-md p-2 border-none outline-none text-lg'>
