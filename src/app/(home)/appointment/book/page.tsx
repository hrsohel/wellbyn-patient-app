...
<path d="M9.66699 11V7" stroke="#3D3D3D" stroke-linecap="round"/>
        ...
        <button
          className="w-full bg-[#2E8BC9] hover:bg-blue-600 text-white py-2 text-base font-medium rounded-md"
      ...
      {showTimer && (
        <div className=" inset-0  bg-[#F2F8FD] flex items-center justify-center z-50">
          <div className="bg-[#F2F8FD] shadow-md absolute left-[450px] bottom-[-85px] rounded-lg p-6 mx-4 w-full max-w-sm">
...
<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_3423_46603" result="shape"/>
            ...
            <div className="flex gap-3">
              ...
              <Link className="flex-1 " href="/appointment/prescription">
               <button
                className="rounded-md bg-red-500 w-full py-2 px-4 text-sm font-medium text-white hover:bg-red-600"
