  ...
  return (
    <div className='mt-4'>
        ...
        <div className='mt-6'>
            ...
            <input type="text" name="box-10d" id="box-10d" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='G987654321' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
        </div>
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
            ...
            <div className='w-full'>
                ...
                <input type="date" name="box-14" id="box-14" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Group Health Plan' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
            <div className='w-full'>
                <label htmlFor="box-14-1" className='font-[500] text-[18px] text-[#3D3D3D]'>Qualifier</label>
                <input type="text" name="box-14-1" id="box-14-1" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Illness' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
            ...
            <div className='w-full'>
                ...
                <input type="date" name="box-15" id="box-15" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Group Health Plan' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
            <div className='w-full'>
                <label htmlFor="box-15-1" className='font-[500] text-[18px] text-[#3D3D3D]'>Qualifier</label>
                <input type="text" name="box-15-1" id="box-15-1" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Illness' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
            ...
            <div className='w-full'>
                ...
                <input type="date" name="box-16" id="box-16" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Group Health Plan' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
            <div className='w-full'>
                <label htmlFor="box-15-1" className='text-lg text-[#999]'>To</label>
                <input type="date" name="box-16-1" id="box-16-1" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Illness' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
        <div className='mt-4'>
            <div>
            ...
            <div className='flex items-center justify-center gap-3 flex-wrap md:flex-nowrap'>
                <input type="text" name="box-17-fname" id="box-17-fname" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='First Name' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
                <input type="text" name="box-17-mname" id="box-17-mname" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Middle' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
                <input type="text" name="box-17-lname" id="box-17-lname" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='Last' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
            ...
            <div className='w-full'>
                ...
                <input type="text" name="box-17a" id="box-17a" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
            <div className='w-full'>
                <label htmlFor="box-17b" className='font-[500] text-[18px] text-[#3D3D3D]'>Box 17b: NPI</label>
                <input type="text" name="box-17b" id="box-17b" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
        ...
        <div className='mt-4'>
            ...
            <input type="text" name="box-19" id="box-19" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
        </div>
        ...
        <div className='flex items-end justify-center gap-6 flex-wrap md:flex-nowrap mt-4'>
            ...
            <div className='w-full'>
                ...
                <input type="text" name="box-22" id="box-22" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
            <div className='w-full'>
                <label htmlFor="box-22b" className='font-[500] text-[18px] text-[#3D3D3D]'>Original Reference Number</label>
                <input type="text" name="box-22b" id="box-22b" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
            </div>
        </div>
         <div className='mt-4'>
            <label htmlFor="box-23" className='font-[500] text-[18px] text-[#3D3D3D]'>Box 23: Prior Authorization Number</label>
            <input type="text" name="box-23" id="box-23" className='text[16px] mt-2 border-none outline-none rounded-[8px] p-[12px] w-full' placeholder='' style={{boxShadow: "0 2px 6px rgba(0, 0, 0, 0.1)"}}/>
        </div>
    </div>
  )
}
