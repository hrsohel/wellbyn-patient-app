    ...
    <>
        <header className='flex items-center md:justify-between justify-start md:flex-row flex-col w-full'>
            ...
            <div className='flex items-center justify-end gap-4 mt-12 md:mt-0'>
                <div style={{boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)"}} className='flex items-center justify-center gap-2 rounded-md p-2 w-[95vw] md:w-auto'>
                    <label htmlFor="search"><Image src="/search.svg" alt='search image' width="25" height="25"/></label>
                    <input className='border-none outline-none p-1 text-[0.9rem] md:w-[25rem] w-full' type="search" name="search" id="search" placeholder='Search for a doctor by name or discipline...'/>
                </div>
